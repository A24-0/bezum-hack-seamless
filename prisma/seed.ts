...
async function main() {
  ...
  await prisma.notification.upsert({ where: { id: 'n1' }, update: { projectId: 'p1', type: 'doc', text: '@dev изменил d2 -> review' }, create: { id: 'n1', projectId: 'p1', type: 'doc', text: '@dev изменил d2 -> review' } });
  await prisma.notification.upsert({ where: { id: 'n2' }, update: { projectId: 'p1', type: 'task', text: 'Task t2 связана с PR !42' }, create: { id: 'n2', projectId: 'p1', type: 'task', text: 'Task t2 связана с PR !42' } });
  await prisma.notification.upsert({ where: { id: 'n3' }, update: { projectId: 'p1', type: 'meeting', text: 'Summary m2 автоматически прикреплен к d2' }, create: { id: 'n3', projectId: 'p1', type: 'meeting', text: 'Summary m2 автоматически прикреплен к d2' } });
